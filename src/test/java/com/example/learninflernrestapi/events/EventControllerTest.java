...
import com.example.learninflernrestapi.accounts.AccountRepository;
...
class EventControllerTest extends BaseControllerTest {
    ...
    void creteEvent() throws Exception {
        ...
        mockMvc.perform(post(url)
                ...
                .andExpect(header().string(HttpHeaders.CONTENT_TYPE, MediaTypes.HAL_JSON_VALUE)) // MediaTypes.HAL_JSON_VALUE != application/hal+json;charset=UTF-8
                ...
                .andDo(document("create-event", // todo: 문서화 참조!
                        links(
                        ...
                        relaxedResponseFields( // todo: 현재 문서화에 대한 수정은 잠시 무시하도록 변경했다!
                                ...
                                fieldWithPath("_links.update-event.href").description("link to update update existing event"),
...
//        //given
    ...
    void getEvent404() throws Exception {
        //when //then
        this.mockMvc.perform(get("/api/events/11883")) // pathVariable로 id 값을 넣겠다는 의미
    ...
    void updateEvent() throws Exception {
        ...
        this.mockMvc.perform(put("/api/events/{id}", event.getId())
                ...
                .andExpect(jsonPath("_links.self").exists())
                .andDo(document("update-event")) //todo: 문서화 이어서하기!
        ;
    }
